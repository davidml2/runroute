    ...
    <div className="screen" style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, color: 'var(--dim)' }}>
          {(() => {
            const nameMap = {'북쪽 루프':'North Loop','동남쪽 루프':'Southeast Loop','서남쪽 루프':'Southwest Loop'};
            let n = route?.name || 'Route';
            for (const [kr, en] of Object.entries(nameMap)) { if (n.includes(kr)) { n = n.replace(kr, en); break; } }
            return n;
          })()} Finished 🏅
        </div>
      </div>
