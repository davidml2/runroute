...
const nameMap = {
  '북쪽 루프': 'North Loop',
  '동남쪽 루프': 'Southeast Loop',
  '서남쪽 루프': 'Southwest Loop',
};
function translateName(name) {
  for (const [kr, en] of Object.entries(nameMap)) {
    if (name.includes(kr)) return name.replace(kr, en);
  }
  return name;
}
  ...
  return (
    <div className="screen" style={{ background: 'linear-gradient(160deg, #0B1520, #080D1E)' }}>
      ...
      <div className="header">
        ...
        <span className="header-title">Routes</span>
        <div style={{ width: 60 }} />
      </div>
